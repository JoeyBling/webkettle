 ...
 */
FileUploadField = Ext.extend(Ext.form.TextField,  {
    /**
    ...
    onDisable: function(){
        FileUploadField.superclass.onDisable.call(this);
        this.doDisable(true);
    },
...
// backwards compat
Ext.form.FileUploadField = FileUploadField;
